# 3DAIGC-API Documentation

## API reference

- **[api_documentation.md](api_documentation.md)** — Full REST endpoint reference (OpenAPI mirror)
...
- **[MODEL_LICENSES.md](MODEL_LICENSES.md)** — Commercial-use audit; which routes are disabled by default

## Development

- **[codebase_analysis.md](codebase_analysis.md)** — Architecture notes
- **[vibe_coding_prompt.md](vibe_coding_prompt.md)** — AI-assisted development context
